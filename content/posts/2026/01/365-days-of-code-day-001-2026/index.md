...
The goal of this challenge is pretty obvious; code every day for a year. I didn't necessarily want to start on the first of the year, as I didn't want the gimmick of a _New Year's Resolution_ and I wanted this challenge to stick. I've always enjoyed coding and programming, but I've never stuck with it in long enough stretches to become truly good. Challenging myself to code everyday for a year should hopefully help me get into the habit.

I have more than a few different projects that I want to work on. Most of them are web apps, but I'd like to get some system software engineering with C, C++, Rust, Python, Java and Go into the mix. In the interest of getting started, I'll stick with the web technology. HTML and CSS are hardly _programming_, so I'll get into some PHP and JavaScript as well.
