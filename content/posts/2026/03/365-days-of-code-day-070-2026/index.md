+++
date = '2026-03-31T00:00:01-05:00'
draft = false
title = '365 Days of Code - Day 070'
summary = ''
tags = ['365-days-of-code']
+++
...
1. Automate Backups - Need to pull the backups automatically. Write a script.
1. Finish Linux+ book, schedule certification
1. Network Protocols in C - Close to finish line, need IPv6 working
1. Finish OS book, personal satisfaction
1. Finish Laravel sites, at least up to point of _Laravel From Scratch_ course
1. Rewrite network protocols in Rust
1. Finish Grey-Hat Hacking
1. Finish LDAP Injector in Go
1. Rewrite network protocols in Zig
